...
final class SearchServiceTest extends IntegrationTestCase
{
    ...
    // ============================================================
    // TESTS DES NOUVELLES MÉTHODES DE RECHERCHE
    // ============================================================
    ...
    // ============================================================
    // TESTS AVEC LES MODÈLES FIXTURES
    // ============================================================
    ...
    public function test_search_with_no_searchable_model_throws_exception(): void
    {
        $record = new SearchIndexRecord(
            id: UuidVO::generate(),
            searchable_type: StringVO::from('NonExistentClass'),
            searchable_id: StringVO::from('1'),
            source_column: StringVO::from('name'),
            original_text: StringVO::from('Test'),
            normalized_text: StringVO::from('test'),
            item_words: Sequential::from(['test']),
            ngrams: Sequential::from($this->ngramService->generate('test')->toArray()),
        );
    ...
    public function test_search_with_model_not_implementing_searchable_throws_exception(): void
    {
        ...
        $record = new SearchIndexRecord(
            id: UuidVO::generate(),
            searchable_type: StringVO::from('AndyDefer\LaravelSearch\Tests\Fixtures\Models\TestNonSearchableModel'),
            searchable_id: StringVO::from((string) $model->id),
            source_column: StringVO::from('name'),
            original_text: StringVO::from('Test'),
            normalized_text: StringVO::from('test'),
            item_words: Sequential::from(['test']),
        ...
        $this->expectException(\RuntimeException::class);
        $this->expectExceptionMessage('must implement Searchable');
